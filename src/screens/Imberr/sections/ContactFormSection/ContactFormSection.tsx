...
export const ContactFormSection = (): JSX.Element => {
  ...
  const companyLinks = [
    { text: t('contact_form.company.about_us') },
    { text: t('contact_form.company.leadership') },
    { text: t('contact_form.company.careers') },
    { text: t('contact_form.company.article_news') },
    { text: t('contact_form.company.legal_notice') },
  ];

  const supportLinks = [
    { text: t('contact_form.support.help_center') },
    { text: t('contact_form.support.customer_service') },
    { text: t('contact_form.support.faq') },
    { text: t('contact_form.support.contact_us') },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-16 mb-20 text-center lg:text-left">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-2 lg:col-span-2 gap-8 text-left">
            <div className="flex flex-col gap-6">
              ...
              uppercase ${i18n.language === 'ar' ? 'text-right' : 'text-left'}`}> 
          ...
          <div className="flex flex-col gap-1 text-left">
            <h3 className={`[font-family:'Inter',Helvetica] font-bold text-white text-[14px] tracking-wider uppercase ${i18n.language === 'ar' ? 'text-right' : 'text-left'}`}>
              {t('contact_form.newsletter.title')}
            </h3>

            <div className="flex flex-col gap-1">
              <p className="[font-family:'Inter',Helvetica] font-light text-white text-[12px] leading-relaxed">
                {t('contact_form.newsletter.description')}
              </p>

              <div className="flex flex-col gap-3 mt-2">
                <Input
                  type="email"
                  placeholder={t('contact_form.newsletter.placeholder')}
                ...
                <Button className="w-full h-12 bg-[#2168ff] hover:bg-[#122979] text-white rounded-full flex items-center justify-center gap-2 font-medium transition-all shadow-lg shadow-blue-900/20">
                  ...
                  <span>{t('contact_form.newsletter.button')}</span>
                </Button>
              </div>
            </div>
          </div>
